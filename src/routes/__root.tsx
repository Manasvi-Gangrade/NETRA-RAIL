...
import { TTSProvider } from "@/components/netra/TTSProvider";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NETRA-RAIL · Autonomous Rail-Grid" },
      { name: "description", content: "India's first closed-loop autonomous multi-agent platform for Indian Railways." },
      { name: "author", content: "Team Japan Buddies" },
