...
export function Nav() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#0b1329]/95 backdrop-blur-md text-white border-b border-white/10 shadow-md w-full overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 py-2.5 flex items-center justify-between gap-2 md:gap-4 w-full">
        ...
        <Link to="/" className="flex items-center gap-2 group shrink-0">
          ...
          <div className="leading-tight shrink-0">
            <div className="font-display font-black text-sm md:text-base tracking-tight text-white">
              NETRA-RAIL
            </div>
            <div className="text-[9px] uppercase tracking-[0.16em] text-white/70 font-extrabold hidden sm:block">Autonomous Rail-Grid</div>
          </div>
        </Link>

        {/* Header Nav Links */}
        <nav className="hidden xl:flex items-center gap-1 text-xs font-bold text-white/80 shrink-0">
          <Link to="/" className="px-3 py-1.5 rounded-lg hover:bg-white/10 hover:text-white transition">
            Overview
          </Link>
          <Link to="/flywheel" className="px-3 py-1.5 rounded-lg hover:bg-white/10 hover:text-white transition">
            Flywheel
          </Link>
          <Link to="/radar" className="px-3 py-1.5 rounded-lg hover:bg-white/10 hover:text-white transition">
            GIS Radar
          </Link>
          <Link to="/command-center" className="px-3 py-1.5 rounded-lg hover:bg-white/10 hover:text-white transition">
            Command Center
          </Link>
          <Link to="/architecture" className="px-3 py-1.5 rounded-lg bg-amber-500/20 border border-amber-500/40 text-amber-300 font-extrabold hover:bg-amber-500/30 transition">
            Architecture
          </Link>
        </nav>
        ...
        <div className="flex items-center gap-2 md:gap-3 shrink-0">
          {/* Capsule */}
          <div className="hidden lg:flex items-center gap-2 px-3 py-1 rounded-full border border-white/20 bg-white/10 text-[10px] md:text-xs font-bold text-white shadow-sm shrink-0">
            {/* Time */}
...
export function Footer() {
  return (
    <footer className="mt-20 border-t border-slate-200 bg-white">
      <div className="mx-auto max-w-7xl px-6 py-10 grid md:grid-cols-3 gap-6 text-sm text-slate-600 font-medium">
        <div>
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-slate-900 grid place-items-center">
              <Train className="w-4 h-4 text-white" />
            </div>
            <span className="font-display font-black text-slate-900 text-base">NETRA-RAIL</span>
          </div>
          <p className="mt-2 text-xs text-slate-600 font-semibold">National Enterprise Traffic, Routing & Autonomous Rail-Grid — built for Indian Railways.</p>
        </div>
        <div className="text-xs">
          <div className="font-extrabold text-slate-900 mb-1 text-sm">Far Away Hackathon 2026</div>
          <div className="text-slate-700 font-semibold">Theme: Railways · Closed-loop autonomous AI</div>
          <div className="mt-1 text-slate-600 font-medium">Team Japan Buddies — Manasvi Gangrade · Navneet Kaur · Suhani Sharma · Muskan Lodhi</div>
        </div>
        <div className="text-xs md:text-right">
          <div className="font-extrabold text-slate-900 mb-1 text-sm">System Status</div>
          <div className="flex md:justify-end items-center gap-2 text-slate-700 font-bold">
          ...
          <div className="mt-2">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-50 border border-emerald-300 text-emerald-800 font-black text-xs hover:bg-emerald-100 transition shadow-xs"
